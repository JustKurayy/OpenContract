...
---------------------------------
OpenContract uses bgfx (https://github.com/bkaradzic/bgfx) DirectX11 as the main renderer. The original renderer has not been reversed engineered, nor will I ask GPT-5.6 to do that since I wanted a modern renderer. For future updates I'll switch over to DirectX12 for better rendering. Currently the engine boots into several missions, has a basic renderer and re-uses the old animation system (reversed engineered by GPT-5.6)
